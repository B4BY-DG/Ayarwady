...
banner() {
	cat <<- EOF
		...
		${GREEN}[${WHITE}-${GREEN}]${CYAN} Tool Created by rana mz (nam tu suna huga)${WHITE}
	EOF
}
...
about() {
	{ clear; banner; echo; }
	cat <<- EOF
		${GREEN}Author   ${RED}:  ${ORANGE}RANA MZ ${RED}[ ${ORANGE}NAM TU SUNA HUGA ${RED}]
		${GREEN}Github   ${RED}:  ${CYAN}https://github.com/RANAMZ-zeshi
		${GREEN}Social   ${RED}:  ${CYAN}RANA MZ
		${GREEN}Version  ${RED}:  ${ORANGE}2.1

		${REDBG}${WHITE} RANA MZ
								  [ NAM TU SUNA HUGA ]  ${RESETBG}
